...
for entity, data in data_china.groupby('Entity'):
    plt.plot(data['Year'], data['eating disorders'], label=entity)
plt.title('eating disorder (China)')
plt.ylabel('Angka (per 50.000 orang)')
plt.xlabel('Tahun')
plt.legend(title='Negara')
plt.grid(True)
...
for entity, data in data_indonesia.groupby('Entity'):
    plt.plot(data['Year'], data['eating disorders'], label=entity)
plt.title('eating disorder (Indonesia)')
plt.ylabel('Angka (per 50.000 orang)')
plt.xlabel('Tahun')
plt.legend(title='Negara')
plt.grid(True)
...
for entity, data in data_pakistan.groupby('Entity'):
    plt.plot(data['Year'], data['eating disorders'], label=entity)
plt.title('eating disorder (Pakistan)')
plt.ylabel('Angka (per 50.000 orang)')
plt.xlabel('Tahun')
plt.legend(title='Negara')
plt.grid(True)
