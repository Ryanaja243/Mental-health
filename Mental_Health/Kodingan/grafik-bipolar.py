...
# Grafik untuk bipolar
plt.subplot(2, 2, 1)
for entity, data in data_india.groupby('Entity'):
    plt.plot(data['Year'], data['bipolar'], label=entity)
plt.title('Bipolar (India)')
